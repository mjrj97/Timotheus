...
{
    /// <summary>
    /// Copy of Avalonia's implementation with slight modifications.
    /// </summary>
    public class DesktopLifetime : IApplicationLifetime, IDisposable
    {
        ...
        private static DesktopLifetime _activeLifetime;
        static DesktopLifetime()
        {
