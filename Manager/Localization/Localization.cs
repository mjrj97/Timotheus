	...
	public class Localization
	{
		...
		public static CultureInfo LocalizationCulture
		{
			...
			set
			{
				...
				else if (value.Name == "de-DE")
					CurrentCulture = Culture.deDE;
				else
					CurrentCulture = Culture.Default;
			}
		}
		...
		public static string AddConsentForm_EmptyVersion
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Ein leeres Versionsfeld wird als fehlende Zustimmung gewertet. Sind Sie sicher, dass Sie die Person hinzufügen möchten?";
					default:
		...
		public static string AddConsentForm_OpenWarning
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Sind Sie sicher, dass Sie eine Datei mit einer Liste von Personen öffnen wollen? Diese neue Datei wird von Timotheus in Zukunft verwendet, um die Liste zu erhalten. Alle Daten, die nicht gespeichert wurden, werden gelöscht.";
					default:
		...
		public static string Calendar_OpenWarning
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Sind Sie sicher, dass Sie einen Kalender öffnen wollen? Diese neue Datei wird von Timotheus in Zukunft verwendet, um den Kalender zu erhalten. Alle Daten, die nicht gespeichert wurden, werden gelöscht.";
					default:
		...
		public static string Calendar_AddEvent_ToolTip
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Eine Ereignis zum Kalender hinzufügen";
					default:
		...
		public static string Calendar_Sync_DeleteRemote
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Das Ereignis ist noch im Online-Kalender enthalten.\nVeröffentlichen, um es zu entfernen.";
					default:
		...
		public static string Calendar_Sync_DeleteLocal
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Das Ereignis wird weiterhin lokal gespeichert.\nSpeichern Sie den Kalender, um ihn zu entfernen.";
					default:
		...
		public static string Calendar_Sync_Upload
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Das Ereignis wurde lokal geändert.\nVeröffentlichen, um den Online-Kalender zu aktualisieren.";
					default:
		...
		public static string Calendar_Sync_NewUpload
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Das Ereignis wurde noch nicht veröffentlicht.";
					default:
		...
		public static string Calendar_Sync_Download
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Das Ereignis wurde geändert. Speichern um die Änderungen behalten.";
					default:
		...
		public static string Calendar_Sync_NewDownload
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Das Ereignis ist neu. Speichern um es zu behalten.";
					default:
		...
		public static string Calendar_BackTime_ToolTip
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "In der Zeit zurückgehen";
					default:
		...
		public static string Calendar_DeleteEvent
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Sind sie sicher, dass sie das Ereignis löschen wollen \"#\"?";
					default:
		...
		public static string Calendar_UndoDeleteEvent_Tooltip
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Dieses Ereignis wiederherstellen";
					default:
		...
		public static string Calendar_Export_ToolTip
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Exportiert den Kalender als PDF und zeigt nur die Ereignisse des aktuellen Zeitraums an.";
					default:
		...
		public static string Calendar_ForwardTime_ToolTip
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "In der Zeit vorwärts gehen";
					default:
		...
		public static string Calendar_PeriodBox_ToolTip
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Der aktuelle Zeitraum. Der Kalender zeigt nur Ereignisse in diesem Zeitraum an.";
					default:
		...
		public static string Calendar_PeriodType_ToolTip
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Die aktuelle Art des Zeitraums.";
					default:
		...
		public static string Calendar_Save_ToolTip
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Speichern Sie den aktuellen Kalender (#1). Dadurch wird der Kalender NICHT synchronisiert.";
					default:
		...
		public static string Calendar_SaveAs_ToolTip
		{
			get
			{
				switch (CurrentCulture)
				{
					...
					case Culture.deDE:
						return "Speichern Sie den Kalender als eine neue .ics-Datei. Dadurch wird der Kalender NICHT synchronisiert.";
					default:
